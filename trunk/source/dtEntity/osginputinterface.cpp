...
namespace dtEntity
{
   ...
   ////////////////////////////////////////////////////////////////////////////////
   OSGInputInterface::~OSGInputInterface()
   {
   ...
   bool OSGInputInterface::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa, osg::Object*, osg::NodeVisitor* )
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleKeyUp(const osgGA::GUIEventAdapter& ea)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleKeyDown(const osgGA::GUIEventAdapter& ea)
   {
      int key = ea.getUnmodifiedKey();
      unsigned int contextId = ea.getGraphicsContext()->getState()->getContextID();
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMouseUp(const osgGA::GUIEventAdapter& ea)
   {
      unsigned int contextId = ea.getGraphicsContext()->getState()->getContextID();
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMouseDown(const osgGA::GUIEventAdapter& ea)
   {
      unsigned int contextId = ea.getGraphicsContext()->getState()->getContextID();
      int index;
      switch(ea.getButton())
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMouseMove(const osgGA::GUIEventAdapter& ea)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMouseWheel(const osgGA::GUIEventAdapter& ea)
   {
      ...
      {
      case osgGA::GUIEventAdapter::SCROLL_UP: mMouseScroll = 1; break;
      case osgGA::GUIEventAdapter::SCROLL_DOWN: mMouseScroll = -1; break;
      default: mMouseScroll = 0;
      }
      ...
      if(!mCallbacks.empty())
      {
         ...
         for(Callbacks::iterator i = mCallbacks.begin(); i != mCallbacks.end(); ++i)
         {
            handled |= (*i)->MouseWheel(mMouseScroll, handled, ea.getGraphicsContext()->getState()->getContextID());
         }
         if(handled && !ea.getHandled())
         {
            ea.setHandled(true);
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMultiTouch(const osgGA::GUIEventAdapter& ea)
   {     
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void OSGInputInterface::HandleMouseEnterLeave(const osgGA::GUIEventAdapter& ea)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   osgGA::GUIEventAdapter::KeySymbol OSGInputInterface::GetKeySymbol(const std::string& name)  const
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetKey(const std::string& v, unsigned int contextId)  const
   {  
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetKeyUp(const std::string& v, unsigned int contextId)  const
   {
      std::pair<unsigned int, int> pair(contextId, GetKeySymbol(v));
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetKeyDown(const std::string& v, unsigned int contextId)  const
   {
      std::pair<unsigned int, int> pair(contextId, GetKeySymbol(v));
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::AnyKeyDown() const
   {
      return (!mKeyDownSet.empty());
   }

   ////////////////////////////////////////////////////////////////////////////////
   std::string OSGInputInterface::GetInputString() const
   {
      return mInputString.str();
   }

   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetMouseButton(int button, unsigned int contextId) const
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetMouseButtonDown(int button, unsigned int contextId) const
   {
      std::pair<unsigned int, int> pair(contextId, button);
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool OSGInputInterface::GetMouseButtonUp(int button, unsigned int contextId) const
   {
      std::pair<unsigned int, int> pair(contextId, button);
   ...
   ////////////////////////////////////////////////////////////////////////////////
   int OSGInputInterface::GetMouseWheelState(unsigned int contextId) const
   {
