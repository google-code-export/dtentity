...
namespace dtEntityCEGUI
{
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool ScriptModule::NotSupported(const std::string& methodName)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   int ScriptModule::executeScriptGlobal(const CEGUI::String& functionName)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   const ScriptModule::CallbackRegistry& ScriptModule::GetRegistry() const
   {
      return mCallbacks;
   }
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void ScriptModule::destroyBindings(void)
   {
      mCallbacks.clear();
