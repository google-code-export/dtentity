...
#ifndef DELTA_ENTITY_PHYSX_EXPORT
#define DELTA_ENTITY_PHYSX_EXPORT
...
#    define DT_ENTITY_PHYSX_EXPORT __declspec(dllexport)
#  else
#     define DT_ENTITY_PHYSX_EXPORT __declspec(dllimport)
#   endif
#else
#   ifdef DT_ENTITY_PHYSX_LIBRARY
#      define DT_ENTITY_PHYSX_EXPORT __attribute__ ((visibility("default")))
#   else
#      define DT_ENTITY_PHYSX_EXPORT
#   endif
#endif
