...
* 
* Modified and adapted by Martin Scheffler
*/

#ifndef DTENTITY_PHYSX_CULLVISITOR_COMPONENT
#define DTENTITY_PHYSX_CULLVISITOR_COMPONENT
...
{
   class PhysXPagedTerrainSystem;
   /** Directly lifted from Stealth Viewer:
    * File SimCore/SimCoreCullVisitor.h
    * Responsible for loading terrain tiles into the physics system
    */
   class PagedTerrainCullVisitor : public osgUtil::CullVisitor
   {
   public:
      /// Constructor
      PagedTerrainCullVisitor(dtEntity::EntityManager& em);
   ...
   protected:
      /// Destructor
      virtual ~PagedTerrainCullVisitor();
   ...
   private:
      ...
      // is set to true when visiting highest detail LOD subgraph
      bool mInHighDetailLOD;
...
#endif // DTENTITY_PHYSX_CULLVISITOR_COMPONENT
