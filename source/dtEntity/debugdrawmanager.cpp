...
namespace dtEntity
{
   ...
   ////////////////////////////////////////////////////////////////////////////////
   DebugDrawManager::DebugDrawManager(dtEntity::EntityManager& em, StringId layerName)
   : mEnabled(false)
   , mGroupDepthTest(new osg::Group)
   , mGroupNoDepthTest(new osg::Group)
   , mCurrentTime(0)
   , mEntityManager(&em)
   , mEnableFunctor(this, &DebugDrawManager::OnEnable)
   , mTickFunctor(this, &DebugDrawManager::Tick)
   ...
   ////////////////////////////////////////////////////////////////////////////////
   bool DebugDrawManager::IsEnabled() const
   {
      return mEnabled;
   }

   ////////////////////////////////////////////////////////////////////////////////
   void DebugDrawManager::OnEnable(const Message& m)
   {
      SetEnabled(m.GetBool(EnableDebugDrawingMessage::EnableId));
   }

   ////////////////////////////////////////////////////////////////////////////////
   void DebugDrawManager::Tick(const Message& m)
   {
   ...
   ////////////////////////////////////////////////////////////////////////////////
   void DebugDrawManager::AddDrawable(osg::Drawable* drawable, float duration, bool depthTestEnabled)
   {
      if(!mEnabled)
         return;
      TimedGeode* geode = new TimedGeode;
